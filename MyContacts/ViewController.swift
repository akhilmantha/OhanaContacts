...
//  MyContacts
//
//  Created by akhil mantha on 08/06/17.
...
class ViewController: UITableViewController, CNContactPickerDelegate, CNContactViewControllerDelegate{
    ...
    fileprivate func showContactViewController() {
        // Search for the person named "Mantha" in the Contacts
        let name = "Mantha"
        ...
        // Display "Mantha" information if found in the address book
        if !contacts.isEmpty {
            ...
            // Show an alert if "Mantha" is not in Contacts
    ...
    fileprivate func showUnknownContactViewController() {
        ...
        let newEmail = CNLabeledValue(label: CNLabelOther, value: "akhilmantha@gmail.com" as NSString)
        ...
        ucvc.alternateName = "Akhil Mantha"
        ucvc.title = "Akhil Mantha"
